...
const ExpenseItem = (props) => {
  ...
  const showSingleExpenseMessage = filteredExpenses.length === 1;
  ...
  return (
    <div className='expense-item'>
      ...
      {!hasExpenses && <h3>No expenses found</h3>}
      {showSingleExpenseMessage && <h4>Only single expense here. Please add more...</h4>}
    </div>
  );
};
